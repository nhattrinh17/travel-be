...
export class DetailLocationController {
  ...
  findAll(@Pagination() pagination: PaginationDto, @Query('destinationId') destinationId: number) {
    return this.detailLocationService.findAll(pagination, destinationId);
  }
